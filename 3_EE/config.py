...
def get_opts_ee():
    ...
    parser.add_argument('--dataset', type=str, default="sent/casie")
    ...
    parser.add_argument('--threshold_head_tail', type=int, default=50)
    ...
    # report metric
    parser.add_argument('--result_file', type=str, default="ee_result.json")
